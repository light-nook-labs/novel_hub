...
class Mapping:
    ...
    def value_to_zh_dict(self) -> dict[int, str]:
        """Return {value: zh_label} mapping for reverse conversion."""
        return {m.value: self._en_zh.get(m.name.lower(), "其他") for m in self._enum}
