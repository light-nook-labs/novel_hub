"""PostgreSQL-only: Update database from a JSONL file (INSERT + UPDATE).

Uses COPY for bulk inserts, temp-table COPY for upserts, and ANALYZE
...
class Command(BaseCommand):
    help = "PostgreSQL-only: Update database from a JSONL file (COPY + UPSERT)"
